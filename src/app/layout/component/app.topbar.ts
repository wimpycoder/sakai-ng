...
@Component({
    selector: 'app-topbar',
    standalone: true,
    imports: [RouterModule, CommonModule, StyleClassModule, AppConfigurator, BranchSelectorComponent],
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <a class="layout-topbar-logo" routerLink="/">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="80.000000pt" height="44.000000pt" viewBox="0 0 300.000000 165.000000" preserveAspectRatio="xMidYMid meet" style="fill: var(--primary-color)">
